...
public class AfficherCatController implements Initializable {
     ...
     */
        ObservableList<categorie> list2;

    @Override
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        Servicecategorie pService = new Servicecategorie();
       list2 = pService.Afficher_categorie();
       if(list2.size()!=0){
       try {
    ...
    public static AnchorPane createPromotion(categorie j,categorie b) {
...
Servicecategorie sv= new Servicecategorie();
                ...
                l1.setText("Nom : "+j.getNom());
                l2.setText("Type  :  "+j.getType());
                l3.setText("Description: "+j.getDescription());
...
//            l6.setText(" "+j.getPrix()+" ");
            ...
            if(i==1){
                ...
                l1.setText("Nom : "+b.getNom());
                l2.setText("Type  :  "+b.getType());
                l3.setText("Description: "+b.getDescription());
                //l5.setText("Pourcentage :  "+b.getPrix());
                //float resultat = j.getCout_fin() * (100-j.getCout_hj())/100;
...
//            test.getChildren().addAll(rating,buy,download,download2);
    ...
    public static AnchorPane createPromotion2(categorie j) {
...
//        promotionpage.getChildren().add(pagination);
    ...
    @FXML
    private void triCCCCCC(MouseEvent event) {
        vboxafficher.getChildren().clear();
        Servicecategorie sr= new Servicecategorie();
